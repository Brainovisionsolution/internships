        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Register for Virtual Internship
            </h2>
            <p className="text-lg text-gray-700">
              Join our live virtual internship program and learn from industry experts
            </p>
          </div>
            ...
            <div>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                <div className="p-6 bg-purple-600 text-white">
                  <h3 className="text-2xl font-bold mb-2">Virtual Registration Form</h3>
                  <p className="text-purple-100">Select your preferred batch date and time</p>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="pt-4 pb-2 border-t border-gray-200">
                    ...
                    <a 
                      ...
                      className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg px-4 py-3 flex items-center justify-center transition-colors duration-300"
                      target="_blank"
