...
const WhyJoinUs: React.FC<WhyJoinUsProps> = ({ isOnline = false, isHybrid = false }) => {
  ...
  { 
  name: 'Weekend Live Classes', 
  intensive: 'Every weekend you will have online live classes and doubt clarification sessions with mentors', 
  others: 'Limited support and no regular live doubt sessions' 
},
