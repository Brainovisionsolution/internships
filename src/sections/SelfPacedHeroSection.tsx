...
const SelfPacedHeroSection: React.FC = () => {
  ...
  <span className="text-sm font-medium">Self-Paced Internship Program · 2026</span>
</div>

<h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
  SELF-PACED INDUSTRY-READY
...
<p className="text-lg md:text-xl text-green-100 mb-8 max-w-xl">
  ...
  real-world projects, mentor guidance, and career support — anytime, anywhere.
</p>
  ...
  <li>✔ Resume, GitHub & LinkedIn profile guidance</li>
                ...
                <div className="mt-6 pt-6 border-t border-indigo-200 border-opacity-20">
                  ...
                  <div className="flex items-baseline">
                    ...
                    <span className="ml-2 bg-green-500 text-white text-xs px-2 py-1 rounded">60% OFF</span>
                  </div>
                  <a
                    href="https://rzp.io/rzp/Kd55zA0"
